...
<body>
    ...
    <nav class="font-Ubuntu">
        ...
        <ul class="nav-list">
            ...
            <li class="nav-item">
                <a class="nav-link" href="http://localhost:8080/1640/?page=privacy_policy.php">Privacy</a>
            </li>
            <!-- Welcome non-fix -->
    ...
    <ul class="nav nav-pills nav-stacked">
        <li><a href="<?php echo "?page=" . $categories; ?>">Category</a></li>
        <li><a href="<?php echo "?page=" . $post; ?>">Post</a></li>
    </ul>
</div>
</body>
